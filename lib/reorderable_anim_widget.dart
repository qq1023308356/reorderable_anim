...
class ReorderableAnimWidget<T> extends ImplicitlyAnimatedWidget {
  const ReorderableAnimWidget(
      {required this.child,
...
class _DragAnimWidgetState extends AnimatedWidgetBaseState<ReorderableAnimWidget> {
...
class _DragAnimRender extends SingleChildRenderObjectWidget {
  ...
  bool get isExecute => !ReorderableAnimNotification.isScroll;
